...
Brewer.ComboEstado = (function() {
	...
	function ComboEstado() {
		this.combo = $('#estado');
		this.emitter = $({}); // Objeto para nos auxiliar a lançar eventos
		this.on = this.emitter.on.bind(this.emitter); // Objeto para lançar os eventos com a ajuda do objeto emitter
	}
