...
import br.com.brewer.repository.pagination.PaginationUtil;
...
public class CervejasImpl implements CervejasQueries {
	...
	public List<CervejaDTO> porSkuOuNome(String skuOuNome) {
		...
		jpql.append("SELECT NEW br.com.brewer.dto.CervejaDTO(codigo, sku, nome, origem, valor, foto) ");
		jpql.append("FROM Cerveja WHERE sku LIKE LOWER(:skuOuNome) OR nome LIKE LOWER(:skuOuNome)");
